...
const BACKEND_NAME: &str = "mcp-links-service-backend.exe";
const BACKEND_PORT: u16 = 11173;
const BACKEND_TAG: &str = "mcp-links-service-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "MCP_LINKS_SERVICE_PORT";
const ENV_HOST: &str = "MCP_LINKS_SERVICE_HOST";
const ENV_TAURI: &str = "MCP_LINKS_SERVICE_TAURI";
